<template>
	<view class="page">
		...
		<view class="security-list">
			<uni-list>
				<uni-list-item title="实名认证" note="完成实名认证，尊享更多服务" clickable showArrow 
					:show-extra-icon="true"  :extra-icon="{color: '#DE4A29',size: '30',type: 'auth-filled'}"
					@click="onSecurity('realname')" />
					
				<uni-list-item title="修改登录密码" note="建议您定期更改密码以保护账户安全" clickable showArrow 
					:show-extra-icon="true"  :extra-icon="{color: '#DE4A29',size: '30',type: 'locked-filled'}"
					@click="onSecurity('password')" />
			</uni-list>
			
			<!-- <view class="list" @click="onSecurity('realname')">
				<view class="content">
					<view class="title">
						<text>实名认证</text>
					</view>
